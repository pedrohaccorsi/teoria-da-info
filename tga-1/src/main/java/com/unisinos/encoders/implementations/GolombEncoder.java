...
public class GolombEncoder implements Encoder {
    ...
    public String encode(int numberToEncode) {
        ...
        return StringUtils.createStringSequence(REPEAT_BIT, prefix)
                + STOP_BIT
                + determineSuffixBinary(suffixLength, suffix);
    }
    ...
    private String determineSuffixBinary(int suffixLength, int suffix) {
